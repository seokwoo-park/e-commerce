...
const Cart = ({ cart, handleCartQuantity, handleRemoveCart, handleEmptyCart }) => {
            ...
            <Grid container spacing={3}>
                {cart.line_items.map((item)=>(
                    <Grid item xs={12} sm={4} key={item.id}>
                        <CartItem item={item} handleCartQuantity={handleCartQuantity} handleRemoveCart={handleRemoveCart}/>
                    </Grid>
                ))}
            </Grid>
